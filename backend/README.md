...
## Project Structure
    ...
    ├── testapiautoteammem_112854  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112854`
...
2. Clone this repo and `cd testapiautoteammem_112854`
